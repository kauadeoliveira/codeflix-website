...
export default function Header() {
    ...
    return(
        <>
            <header className='w-full flex justify-between items-center text-white sm:text-2xl md:text-lg py-1 px-4 md:px-6 md:py-2 fixed top-0 left-0'>
                <button onClick={handleOpenMenu} className='block md:hidden'>
                    <HiOutlineMenu />
                </button>
                <a href="/" className='font-caveat text-2xl md:text-4xl'>
                    Codeflix
                </a>
